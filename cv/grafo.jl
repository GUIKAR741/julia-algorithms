...
mutable struct GeradorGrafo
    ...
    function GeradorGrafo(n)
        ...
        self.pcvGenetico=function(tam_pop::Int64, geracoes::Int64,
    		...
    		println("Melhor indivíduo: - Custo: ",obter_custo(melhor_individuo))
...
gg.mostraGrafo()
print("Aleatorio: ")
@time gg.pcvRandom(100000)
print("\nGenetico: ")
@time gg.pcvGenetico(500, 100000, 2, 0.7, 0.01)
