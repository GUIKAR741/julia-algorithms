...
class GeradorGrafo:
	...
	def pcv_random(self, iteracoes):
		...
		print('Melhor circuito: Custo: %d' % (melhor_custo))
	...
	def pcv_genetico(self, tam_pop, geracoes, tam_torneio, prob_cruz, prob_mut):
		...
		print('Melhor indivíduo: Custo: %d' % (obter_custo(melhor_individuo)))


grafo = GeradorGrafo(1000)
grafo.gerar_grafo()
print('Random: ',end='')
grafo.pcv_random(1000)
print('Algoritmo Genético: ',end='')
grafo.pcv_genetico(tam_pop=2000, geracoes=1000, tam_torneio=2, prob_cruz=0.7, prob_mut=0.15)
